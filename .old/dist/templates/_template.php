					...
					<div class="flex flex-wrap">
									...
									<ul class="list-reset flex flex-wrap items-center">
										...
										<li class="mr-2 pr-1">
											<a href="https://facebook.com/sharer/sharer.php?u=<?PHP echo urlencode($pageURL); ?>" target="_blank" aria-label="" data-toggle="tooltip" data-placement="bottom" title="Share on Facebook">
												<svg viewBox="0 0 24 24" class="fill-current h-4 text-brand hover:text-teal" xmlns="http://www.w3.org/2000/svg">
										...
										<li class="mr-2 pr-1">
											<a href="mailto:?subject=Check%20out%20this%20link%20on%20TailwindToolbox.com&amp;body=<?PHP echo $pageDESC; ?>%20(<?PHP echo urlencode($pageURL); ?>)" target="_self" aria-label="" data-toggle="tooltip" data-placement="bottom" title="Share on Email">
												<svg viewBox="0 0 20 20" class="fill-current h-4 text-brand hover:text-teal" xmlns="http://www.w3.org/2000/svg">
						...
						<div class="w-full lg:w-2/5 xl:w-1/4 p-8 my-8 lg:my-0 bg-gray-200 rounded">
							...
							<div class="flex flex-col pb-6 text-center">
								<a href="<?= $pageDL; ?>" class="no-underline hover:no-underline" target="_blank" rel="noopener" download><button class="w-full max-w-sm mx-auto flex items-center justify-center bg-brand hover:bg-teal-500 outline-none focus:border-teal-900 text-white font-extrabold py-3 px-5 rounded shadow"><svg class="inline fill-current h-4 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
					...
					<div class="rounded-b overflow-hidden mx-auto w-full mt-3 sm:mt-6 lg:mt-8 mb-4 shadow-lg" id="device">
						<div class="window-nav flex justify-between">
							...
							<div class="flex items-center">
								...
								<button class="hidden md:block flex items-center hover:bg-teal-500 text-sm font-extrabold p-1 mr-2 rounded" onclick="goMobile()"> <svg class="h-6 w-6 fill-current text-teal-100 inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
								...
								<button class="hidden md:block flex items-center hover:bg-teal-500 text-sm font-extrabold p-1 mr-2 rounded" onclick="goTablet()"><svg class="h-6 w-6 fill-current text-teal-100 inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
										<path d="M392 32H120c-13.3 0-24 10.7-24 24v400c0 13.3 10.7 24 24 24h272c13.3 0 24-10.7 24-24V56c0-13.3-10.7-24-24-24zm-8 384H128V80h256v336zm-128 46c-7.7 0-14-6.5-14-14.1 0-7.5 6.2-14 14-14 7.7 0 14.1 6.4 14.1 14-.1 7.6-6.4 14.1-14.1 14.1z" />
									</svg></button>
								<button class="hidden md:block flex items-center hover:bg-teal-500 text-sm font-extrabold p-1 mr-2 rounded" onclick="goDesktop()"><svg class="h-6 w-6 fill-current text-teal-100 inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
								...
								<a href="<?= $pageSRC; ?>" class="flex items-center hover:bg-teal-500 text-sm font-extrabold p-1 mr-2 rounded" target="_blank" rel="noopener"><svg class="h-6 w-6 fill-current text-teal-100 inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
<div class="w-full lg:w-4/5 py-4 mx-auto">
	...
	<pre>';
					...
					<p class="mt-8 p-6 w-full container mx-auto bg-teal-lightest text-center text-gray-dark">Find more templates at: <a class="font-extrabold text-teal-dark hover:text-teal-darkest" href="https://www.tailwindtoolbox.com/starter-templates" target="_blank" rel="noopener">www.TailwindToolbox.com/starter-templates</a></p>
	...
	<div class="container mx-auto mb-16 mt-6" id="home-affiliates">
		<div class="w-full px-1 md:px-0">

			<h2 class="font-bold text-xl md:text-3xl text-brand text-center pb-4 md:pb-8">Promoted Content</h2>

			<p class="px-6 pb-4 md:pb-8 text-gray-darker leading-normal text-base md:text-xl">Need some more blocks/layouts, design tools or inspiration? Check out some of these amazing tools from friends of the site to help kickstart your project!</p>
