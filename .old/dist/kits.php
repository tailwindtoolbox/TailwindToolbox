...
<body class="leading-normal tracking-normal bg-brand-white nunito">
	...
	<div class="z-20 flex items-center pb-6 mt-24 mb-6 text-center bg-cover" style="background-image: url(bg.svg)">
		<div class="flex flex-col items-center justify-center w-full pt-6 md:pt-16">
			<div class="px-3">
				<h1 class="pt-6">
					<span class="px-3 mb-5 text-3xl font-bold text-center text-white bg-brand sm:text-4xl sm:mb-16" style="box-decoration-break: clone;-webkit-box-decoration-break: clone;"><span>Tailwind UI Kits and Building tools</span></span>
				</h1>
				<p class="max-w-3xl mx-auto my-6 text-base font-bold leading-normal text-left lg:text-xl lg:text-center">Tailwind CSS UI Kits, Component Kits and website building tools to speed up your development process.</p>
			</div>
		</div>
	</div>
			...
			<div class="sticky flex flex-col pin-t" style="top:9em;">
				...
				<div class="order-2 w-full pt-6 pl-0 pl-3 bg-brand-white md: md:pt-0 md:order-1">
					...
					<ul class="container flex flex-row mx-auto text-sm border-b scroll list-reset md:flex-col md:pb-4 md:text-base bounce-in-right">
						...
						<?php
						$filters = array('Boilerplate', 'UI Kit', 'Page Builder');
