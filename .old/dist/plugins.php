...
<body class="leading-normal tracking-normal bg-brand-white nunito">
	...
	<div class="z-20 flex items-center pb-6 mt-24 mb-6 text-center bg-cover" style="background-image: url(bg.svg)">
		<div class="flex flex-col items-center justify-center w-full pt-6 md:pt-16">
			<div class="px-3">
				<h1 class="pt-6">
					<span class="px-3 mb-5 text-3xl font-bold text-center text-white bg-brand sm:text-4xl sm:mb-16" style="box-decoration-break: clone;-webkit-box-decoration-break: clone;"><span>Tailwind Plugins</span></span>
				</h1>
				<p class="max-w-3xl mx-auto my-6 text-base font-bold leading-normal text-left lg:text-xl lg:text-center">Some useful plugins for extending Tailwind CSS. Find out more about writing your own plugin <a class="font-extrabold text-teal-dark hover:text-teal-darkest" href="https://tailwindcss.com/docs/plugins" target="_blank" rel="noopener">here</a></p>
			</div>
		</div>
	</div>
			...
			<div class="sticky flex flex-col pin-t" style="top:9em;">
				...
				<div class="order-2 w-full pt-6 pl-0 pl-3 bg-brand-white md: md:pt-0 md:order-1">
					...
					<ul class="container flex flex-row mx-auto text-sm border-b scroll list-reset md:flex-col md:pb-4 md:text-base">
						...
						<?php
						$filters = array('Official', 'Utilities', 'Variants');
  ...
  <a href="##statlink##" class="native-card" style="background: ##backgroundColor##; color: ##textColor##;">
    ...
    `
		...
		<div class="w-full px-0 md:w-4/5">
			...
			<p class="container w-full p-6 mx-auto my-8 text-center text-gray-dark">If you have any useful plugins which will make your Tailwind CSS experience better, please drop us a tweet: <a class="font-extrabold text-teal-dark hover:text-teal-darkest" href="https://www.twitter.com/tailwindtoolbox" target="_blank" rel="noopener">@TailwindToolbox</a></p>
