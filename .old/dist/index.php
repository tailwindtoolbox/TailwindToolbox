...
<body class="h-full overflow-x-hidden leading-normal tracking-normal bg-cover bg-brand-white nunito" style="background-image: url(mesh.svg)">
...
<?php include 'includes/nav-home.php'; ?>
	...
	<div class="z-20 flex items-center mt-24 bg-cover " style="background-image: url(bg.svg)">
		<div class="flex flex-col items-center justify-center w-full pt-6 sm:pt-16">
			<div class="max-w-3xl px-3 mx-auto lg:max-w-full">
				<h1 class="pt-6">
					<span class="px-3 mb-5 text-3xl font-bold text-center text-white rounded-lg bg-brand sm:text-4xl sm:mb-16" style="box-decoration-break: clone;-webkit-box-decoration-break: clone;"><span>Free Tailwind CSS Templates, Components and Resources</span></span>
				</h1>
				<p class="max-w-3xl mx-auto my-6 text-base font-bold leading-normal text-left lg:text-xl lg:text-center">Open source starter <a href="https://www.tailwindtoolbox.com/starter-templates">templates</a> and <a href="https://www.tailwindtoolbox.com/starter-components">components</a>, a directory of handy <a href="https://www.tailwindtoolbox.com/kits">building kits</a>, <a href="https://www.tailwindtoolbox.com/generators">generators</a>, <a href="https://www.tailwindtoolbox.com/plugins">plugins</a> and useful <a href="https://www.tailwindtoolbox.com/tools">tools</a> to kick start your Tailwind CSS project</p>
			</div>
			...
			<div class="relative max-w-3xl px-6 mx-auto">
					...
					<input id="search-toggle" type="search" placeholder="Enter search term ('/' to focus)" class="block w-full py-3 pl-12 pr-4 font-bold text-gray-700 bg-gray-100 rounded-lg shadow focus:outline-none focus:bg-white" onkeyup="updateSearchResults(this.value);">
					<div class="mt-1">
						<div id="search-content" class="z-50 w-full overflow-y-auto text-gray-600 rounded-lg text" style="max-height: 500px;">
  ...
  <a href="##statlink##" class="native-card" style="background: ##backgroundColor##; color: ##textColor##;">
    ...
    `
		...
		<div class="w-full px-0 md:w-4/5"><?php
											...
											?><?php
												...
												?><?php
													...
													include 'includes/render-home.php';
													?></div>
	</div><?php include 'includes/footer.php'; ?><div class="font-normal text-indigo-300 hover:bg-teal-100"></div><span class="flex items-center justify-between hidden p-4 border-b group hover:bg-teal-100"><a class="flex-1 block no-underline" href="#">
			<p class="text-sm font-bold text-indigo-600 hover:text-indigo-500"><span class="mr-2 text-teal-500">#</span><span class="font-normal text-indigo-300">by author <svg class="inline-block h-4 pl-2 fill-current text-brand" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
		...
		</a><a href="#"><img class="hidden h-16 border-none md:block" src="https://www.tailwindtoolbox.com/"></a></span><?php include 'includes/js.php'; ?>
</body>
