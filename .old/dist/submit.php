...
<body class="leading-normal tracking-normal bg-brand-white nunito">
	...
	<div class="z-20 flex items-center pb-6 mt-24 mb-6 text-center bg-cover" style="background-image: url(bg.svg)">
		<div class="flex flex-col items-center justify-center w-full pt-6 md:pt-16">
			<div class="px-3">
				<h1 class="pt-6">
					<span class="px-3 mb-5 text-3xl font-bold text-center text-white bg-brand sm:text-4xl sm:mb-16" style="box-decoration-break: clone;-webkit-box-decoration-break: clone;"><span>Submit to Tailwind Toolbox</span></span>
				</h1>
				<p class="max-w-3xl mx-auto my-6 text-base font-bold leading-normal text-left lg:text-xl lg:text-center">Happy to add anything open source you have created or found which will help the Tailwind CSS community.</p>
			</div>
		</div>
	</div>
		...
		<div class="w-full px-4 lg:w-3/5">
			...
			<form id="requestForm">
				...
				<div class="mt-4">
					...
					<div class="flex flex-wrap justify-center w-full mx-auto mt-6 lg:w-4/5">
						...
						<div class="flex flex-col items-center pr-4 mb-2 transition duration-300 ease-in-out transform">
							<input id="Template" type="radio" name="section" class="z-50 order-last w-16 h-16 -mt-4 form-checkbox form-checkbox-availability">
							<label for="Template" class="flex flex-col items-center w-32 px-6 py-6 text-center border-2 border-gray-400 rounded-lg hover:bg-white">
								<span class="mb-3">
						...
						<div class="flex flex-col items-center pr-4 mb-2 transition duration-300 ease-in-out transform">
							<input id="Component" type="radio" name="section" class="z-50 order-last w-16 h-16 -mt-4 form-checkbox form-checkbox-availability">
							<label for="Component" class="flex flex-col items-center w-32 px-6 py-6 text-center border-2 border-gray-400 rounded-lg hover:bg-white">
								<span class="mb-3">
									<svg class="w-8 h-8 text-brand" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						...
						<div class="flex flex-col items-center pr-4 mb-2 transition duration-300 ease-in-out transform">
							<input id="Kit" type="radio" name="section" class="z-50 order-last w-16 h-16 -mt-4 form-checkbox form-checkbox-availability">
							<label for="Kit" class="flex flex-col items-center w-32 px-6 py-6 text-center border-2 border-gray-400 rounded-lg hover:bg-white">
								<span class="mb-3">
									<svg class="w-8 h-8 text-brand" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						...
						<div class="flex flex-col items-center pr-4 mb-2 transition duration-300 ease-in-out transform">
							<input id="Generator" type="radio" name="section" class="z-50 order-last w-16 h-16 -mt-4 form-checkbox form-checkbox-availability">
							<label for="Generator" class="flex flex-col items-center w-32 px-6 py-6 text-center border-2 border-gray-400 rounded-lg hover:bg-white">
								<span class="mb-3">
									<svg class="inline h-8 fill-stroke text-brand" fill="none" viewBox=" 0 0 24 24" stroke="currentColor">
						...
						<div class="flex flex-col items-center pr-4 mb-2 transition duration-300 ease-in-out transform">
							<input id="Tool" type="radio" name="section" class="z-50 order-last w-16 h-16 -mt-4 form-checkbox form-checkbox-availability">
							<label for="Tool" class="flex flex-col items-center w-32 px-6 py-6 text-center border-2 border-gray-400 rounded-lg hover:bg-white">
								<span class="mb-3">
									<svg class="w-8 h-8 text-brand" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
						...
						<div class="flex flex-col items-center pr-4 mb-2 transition duration-300 ease-in-out transform">
							<input id="Plugin" type="radio" name="section" class="z-50 order-last w-16 h-16 -mt-4 form-checkbox form-checkbox-availability">
							<label for="Plugin" class="flex flex-col items-center w-32 px-6 py-6 text-center border-2 border-gray-400 rounded-lg hover:bg-white">
								<span class="mb-3">
									<svg class="w-8 h-8 text-brand" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						...
						<div class="flex flex-col items-center pr-4 mb-2 transition duration-300 ease-in-out transform">
							<input id="Guide" type="radio" name="section" class="z-50 order-last w-16 h-16 -mt-4 form-checkbox form-checkbox-availability">
							<label for="Guide" class="flex flex-col items-center w-32 px-6 py-6 text-center border-2 border-gray-400 rounded-lg hover:bg-white">
								<span class="mb-3">
									<svg class="w-8 h-8 text-brand" fill="none" viewBox="0 0 24 24" stroke="currentColor">
				...
				<label class="block pb-3 mt-3">
					...
					<input id="srcTitle" name="title" class="block w-full mt-1 form-input" placeholder="Short title" onKeyUp="change(this.value,'outputTitle','Add Title')">
				</label>

				<label class="block pb-3 mt-3">
					<span class="pb-3 text-gray-700">Short Description</span>
					<textarea id="srcDesc" name="description" class="block w-full mt-1 form-textarea" rows="3" placeholder="Enter short description (will appear on hover)" onKeyUp="change(this.value,'outputDesc','Short Description which appears on hover')"></textarea>
				</label>

				<label class="block pb-3 mt-3">
					<span class="pb-3 text-gray-700">URL for Image</span>
					<input id="srcImgUrl" name="imgurl" class="block w-full mt-1 form-input" placeholder="I'll create one for you if you leave it blank" onKeyUp="changeImage(this.value,'outputImg','placeholder.png')">
				</label>


				<label class="block pb-3 mt-3">
					<span class="pb-3 text-gray-700">URL</span>
					<input id="srcUrl" name="url" class="block w-full mt-1 form-input" placeholder="Preferably GitHub Repo link">
				</label>

				<label class="block pb-3 mt-3">
					<span class="pb-3 text-gray-700">Author</span>
					<input id="srcAuthor" name="author" class="block w-full mt-1 form-input" placeholder="Author's Name / GitHub username" onKeyUp="change(this.value,'outputAuthor','Author')">
				</label>

				<label class="block pb-3 mt-3">
					<span class="pb-3 text-gray-700">Author Link</span>
					<input id="srcAuthorLink" name="author-link" class="block w-full mt-1 form-input" placeholder="Author's link">
				</label>

				<button onclick="postStuff()" type="button" name="submit_btn" class="flex items-center justify-center w-full max-w-xs px-5 py-3 mx-auto mt-12 font-extrabold text-white rounded shadow outline-none bg-brand hover:bg-teal-500 focus:border-teal-900"><svg class="inline h-4 pr-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						<path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z"></path>
					</svg> Submit</button>

				<div id="status" class="py-3 my-6 font-bold"></div>
				<input id="formreset" type="reset" value="Reset the form" class="flex items-center justify-center hidden w-full max-w-xs px-5 py-3 font-extrabold bg-transparent rounded outline-none hover:bg-brand hover:text-white focus:border-teal-900 text-brand">
