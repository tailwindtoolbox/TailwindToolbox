<?php
	...
	*/
	...
	$pageOFFSET = '0';
	$pageINTRO	= '"Searchy" - a large full width search input field trigged by click<br>
				   <p>* Large search field appearing under the nav bar</p>
				   <p>* Triggered by clicking search icon</p>';
