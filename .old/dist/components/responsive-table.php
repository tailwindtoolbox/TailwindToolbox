...
<?php
	...
	*/
	...
	$pageOFFSET = '0';
	$pageINTRO	= 'Responsive Table<br>
				   <p>*Using <a href="https://datatables.net">https://datatables.net</a></p>
				   <p>*Hides columns as screen gets smaller and displays a toggle icon to view the rest of the data</p>';
