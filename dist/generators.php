...
<head>
	...
	<title>Windy Toolbox - Useful Generators for Tailwind CSS</title>
	<meta name="description"
		content="(Formerly Tailwind Toolbox) Useful generators for Tailwind CSS to help you setup your icons, colours, fonts and much more!">
	<meta name="keywords"
		content="Tailwind Toolbox,tailwind,tailwindcss,tailwind css,css,tailwind example,generator,color,colour,fonts,buttons,icons">
		...
		<div class="flex flex-col items-center justify-center w-full pt-6 md:pt-16">
			<div class="px-3">
				...
				<p
					...
					Some useful generators to help you setup your Tailwind CSS configuration</p>
			</div>
		</div>
	</div>
