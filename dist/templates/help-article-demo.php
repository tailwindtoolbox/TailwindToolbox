   ...
   <body class="bg-grey-lightest tracking-wide tracking-normal">
      ...
      <div class="container w-full flex flex-wrap mx-auto px-2 pt-8 lg:pt-16 mt-16">
         <div class="w-full lg:w-1/5 lg:px-6 text-xl text-grey-darkest leading-normal">
            ...
            <div class="w-full sticky pin hidden h-64 lg:h-auto overflow-hidden overflow-scroll lg:block mt-0 border border-grey-light lg:border-transparent bg-white shadow lg:shadow-none lg:bg-transparent z-20" style="top:5em;" id="menu-content">
               <ul class="list-reset">
         ...
         <div class="w-full lg:w-4/5 p-8 mt-6 lg:mt-0 text-black leading-normal bg-white border border-grey-light border-rounded">
            ...
            <p class="py-6">
               👋 Welcome fellow <a class="text-purple no-underline hover:underline" href="https://www.tailwindcss.com">Tailwind CSS</a> fan.  This starter template provides a starting point to create your own helpdesk / faq / knowledgebase articles using Tailwind CSS and vanilla Javascript.
							 It is a clone of the <a class="text-purple no-underline hover:underline" href="https://www.weebly.com/app/help/topics/first-steps">Weebly Support article</a> with a few modifications. 
            </p>
