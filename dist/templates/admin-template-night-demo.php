...
<head>
    ...
    <meta name="description" content="Tailwind CSS Starter template - Night Mode Admin theme, dashboard, or web application UI!">
    <meta name="keywords" content="tailwind,tailwindcss,tailwind css,css,starter template,free template,fixed header, admin starter template, admin template, admin console, example, night mode, dark mode">
