...
<head>
    ...
    <title>Tailwind Starter Template - Day Admin Template: Windy Toolbox</title>
    <meta name="description" content="(Formerly Tailwind Toolbox) description here">
    ...
    <nav id="header" class="fixed top-0 z-10 w-full bg-white shadow">
        ...
        <div class="container flex flex-wrap items-center w-full pt-3 pb-3 mx-auto mt-0 md:pb-0">
            ...
            <div class="w-1/2 pl-2 md:pl-0">
                <a class="text-base font-bold text-gray-900 no-underline xl:text-xl hover:no-underline" href="#">
                    <i class="pr-3 text-pink-600 fas fa-sun"></i> Admin Day Mode
                </a>
            </div>
                ...
                <div class="relative flex inline-block float-right">
                    ...
                    <div class="relative text-sm">
                        <button id="userButton" class="flex items-center mr-3 focus:outline-none">
                            ...
                            <svg class="h-2 pl-2" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129 129"
                        ...
                        <div id="userMenu"
                            class="absolute top-0 right-0 z-30 invisible min-w-full mt-2 mt-12 overflow-auto bg-white rounded shadow-md">
                            <ul class="list-reset">
                                <li><a href="#"
                    ...
                    <div class="block pr-4 lg:hidden">
                        <button id="nav-toggle"
                            class="flex items-center px-3 py-2 text-gray-500 border border-gray-600 rounded appearance-none hover:text-gray-900 hover:border-teal-500 focus:outline-none">
            ...
            <div class="z-20 flex-grow hidden w-full mt-2 bg-white lg:flex lg:items-center lg:w-auto lg:block lg:mt-0"
                id="nav-content">
                <ul class="items-center flex-1 px-4 list-reset lg:flex md:px-0">
                    <li class="my-2 mr-6 md:my-0">
                        <a href="#"
                            class="block py-1 pl-1 text-pink-600 no-underline align-middle border-b-2 border-pink-600 md:py-3 hover:text-gray-900 hover:border-pink-600">
                            <i class="mr-3 text-pink-600 fas fa-home fa-fw"></i><span
                                class="pb-1 text-sm md:pb-0">Home</span>
                        </a>
                    </li>
                    <li class="my-2 mr-6 md:my-0">
                        <a href="#"
                            class="block py-1 pl-1 text-gray-500 no-underline align-middle border-b-2 border-white md:py-3 hover:text-gray-900 hover:border-pink-500">
                            <i class="mr-3 fas fa-tasks fa-fw"></i><span class="pb-1 text-sm md:pb-0">Tasks</span>
                        </a>
                    </li>
                    <li class="my-2 mr-6 md:my-0">
                        <a href="#"
                            class="block py-1 pl-1 text-gray-500 no-underline align-middle border-b-2 border-white md:py-3 hover:text-gray-900 hover:border-purple-500">
                            <i class="mr-3 fa fa-envelope fa-fw"></i><span class="pb-1 text-sm md:pb-0">Messages</span>
                        </a>
                    </li>
                    <li class="my-2 mr-6 md:my-0">
                        <a href="#"
                            class="block py-1 pl-1 text-gray-500 no-underline align-middle border-b-2 border-white md:py-3 hover:text-gray-900 hover:border-green-500">
                    ...
                    <li class="my-2 mr-6 md:my-0">
                        <a href="#"
                            class="block py-1 pl-1 text-gray-500 no-underline align-middle border-b-2 border-white md:py-3 hover:text-gray-900 hover:border-red-500">
                ...
                <div class="relative pl-4 pr-4 pull-right md:pr-0">
                    <input type="search" placeholder="Search"
                        class="w-full px-2 py-1 pl-10 text-sm leading-normal text-gray-800 transition bg-gray-100 border rounded appearance-none focus:outline-none focus:border-gray-700">
