<?php
	...
	*/
	...
	$pageINTRO	= 'This starter template contains:<br>
				   <p>*A multi section form with scrollspy (indicate the section the screen is currently centered on)</p>
				   <p>*Uses the CDN version of <a href="https://github.com/tailwindcss/custom-forms" target="_blank">Tailwind Custom Forms</a> to style the form fields</p>
