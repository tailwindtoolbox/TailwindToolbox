...
<head>
  ...
  <title>Tailwind Starter Template - Screenshot Landing Page : Windy Toolbox</title>
...
<body class="flex flex-col leading-relaxed tracking-wide gradient">
    ...
    <div class="container flex flex-wrap items-center justify-between w-full px-2 py-2 mx-auto mt-0 lg:py-6">
      <div class="flex items-center pl-4">
        <a class="text-2xl font-bold text-white no-underline hover:no-underline lg:text-4xl" href="#">
          <svg class="inline-block w-6 h-6 text-yellow-700 fill-current" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20">
      ...
      <div
        class="z-20 flex-grow hidden w-full p-4 mt-2 text-black lg:flex lg:items-center lg:w-auto lg:block lg:mt-0 lg:p-0"
        id="nav-content">
        ...
        <button id="navAction"
          class="px-8 py-4 mx-auto mt-4 font-extrabold text-gray-800 rounded shadow opacity-75 lg:mx-0 hover:underline lg:mt-0">
          Action
        </button>
      </div>
    </div>
  ...
  <div class="container h-screen mx-auto">
    <div class="px-3 text-center lg:px-0">
      ...
      <p class="mb-8 text-base leading-normal text-gray-800 md:text-xl lg:text-2xl">
        Sub-hero message, not too long and not too short. Make it just right!
      </p>

      <button
        class="w-48 px-8 py-4 mx-auto my-2 font-extrabold text-gray-800 rounded shadow-lg lg:mx-0 hover:underline md:my-6">
        Sign Up
      </button>
      <a href="#"
        class="inline-block px-8 py-2 mx-auto my-2 font-extrabold text-gray-600 bg-transparent lg:mx-0 hover:underline md:my-6 lg:py-4">View
        Additional Action</a>
    </div>

    <div class="flex items-center content-end w-full mx-auto">
      <div class="flex flex-1 w-1/2 m-6 bg-white rounded shadow-xl browser-mockup md:px-0 md:m-12"></div>
    </div>
  </div>
  ...
  <section class="py-12 bg-white border-b ">
    <div class="container flex flex-wrap items-center justify-between pb-12 mx-auto">
      ...
      <div
        ...
        <span class="flex items-center w-1/2 p-4 md:w-auto"><svg
            class="w-10 h-10 mr-4 text-gray-500 opacity-75 fill-current" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20">
      ...
      <div class="flex flex-wrap">
        ...
        <div class="w-full p-6 sm:w-1/2">
          <svg class="w-full mx-auto sm:h-64" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
            ...
            <path transform="translate(-11.5 -150.75)"
              d="M387.5,490A66.5,66.5,0,1,1,321,423.5,66.47,66.47,0,0,1,387.5,490Z" fill="none" stroke="#f2f2f2"
  ...
  <section class="w-full pt-6 pb-12 mx-auto text-center gradient">
    ...
    <button class="px-8 py-4 mx-auto my-6 font-bold text-gray-800 bg-white rounded shadow-lg lg:mx-0 hover:underline">
      Action!
    </button>
  </section>
      ...
      <div class="flex flex-col w-full py-6 md:flex-row">
        <div class="flex-1 mb-6">
          <a class="text-2xl font-bold text-orange-600 no-underline hover:no-underline lg:text-4xl" href="#">
            <svg class="inline-block w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
              <path d="M13 8V0L8.11 5.87 3 12h4v8L17 8h-4z" />
            </svg>
            Bolt App
          </a>
        ...
        <div class="flex-1">
          ...
          <ul class="mb-6 list-reset">
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
              <a href="#" class="font-light text-gray-800 no-underline hover:underline hover:text-orange-500">FAQ</a>
            </li>
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
              <a href="#" class="font-light text-gray-800 no-underline hover:underline hover:text-orange-500">Help</a>
            </li>
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
              <a href="#"
        ...
        <div class="flex-1">
          ...
          <ul class="mb-6 list-reset">
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
              <a href="#" class="font-light text-gray-800 no-underline hover:underline hover:text-orange-500">Terms</a>
            </li>
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
              <a href="#"
        ...
        <div class="flex-1">
          ...
          <ul class="mb-6 list-reset">
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
              <a href="#" class="font-light text-gray-800 no-underline hover:underline hover:text-orange-500">Official
                Blog</a>
            </li>
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
              <a href="#" class="font-light text-gray-800 no-underline hover:underline hover:text-orange-500">About
                Us</a>
            </li>
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
              <a href="#"
