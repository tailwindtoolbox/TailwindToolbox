<?php
	...
	*/
	...
	$pageINTRO	= 'This starter template contains:<br>
				   <p>*Fixed Header which will always appear at the top of the page</p>
				   <p>*A toggle button to display the nav list in a menu on small screens</p>
				   <p>*Container with 1 column</p>';
...
<body class="bg-brand-white leading-normal tracking-normal nunito">
	...
	<!--header-->
	<div class="h-128 md:h-half pt-16 md:pt-6 bg-cover bg-right flex items-center" style="background-image: linear-gradient(120deg, #84fab0 0%, #8fd3f4 100%);">	
		<div class="flex-1 text-center">
			<span class="bg-brand font-bold text-center text-white text-3xl md:text-5xl px-3 mb-32 sm:mb-16" style="box-decoration-break: clone;-webkit-box-decoration-break: clone;"><?= $pageTITLE;?></span><br>
					...
					<div class="flex flex-wrap">
						...
						<div class="w-full lg:w-4/5 p-3 text-grey-darker leading-normal text-base md:text-xl">
							...
							<div class="py-8 md:py-12">
								<ul class="list-reset flex flex-wrap items-center bg-brand-alt">
									...
									<li class="mr-4 pr-1 md:mr-6">
										<a href="mailto:?subject=Check%20out%20this%20link%20on%20TailwindToolbox.com&amp;body=<?PHP echo $pageDESC; ?>%20(<?PHP echo urlencode($pageURL); ?>)" target="_self" aria-label="" data-toggle="tooltip" data-placement="bottom" title="Share on Email">
											<svg viewBox="0 0 20 20" class="fill-current h-6 md:h-8 text-brand hover:text-teal" xmlns="http://www.w3.org/2000/svg"><path d="M18 2a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4c0-1.1.9-2 2-2h16zm-4.37 9.1L20 16v-2l-5.12-3.9L20 6V4l-10 8L0 4v2l5.12 4.1L0 14v2l6.37-4.9L10 14l3.63-2.9z"/></svg>
										</a>
									</li>
									<li class="mr-4 pr-1 md:mr-6">
						...
						<div class="w-full pt-12">
							...
							<p>Use the toggle buttons to view the template on different devices/viewports.</p>
						</div>
					</div>
