...
<div class="w-full lg:w-4/5 py-4 mx-auto">
	...
	<pre>';
					...
					<div class="my-8 p-6 w-full container mx-auto text-center text-gray-dark">
						Looking for drag'n drop page creator for Tailwind CSS? Check out <a class="font-bold" href="https://a.paddle.com/v2/click/37973/124350?link=3167" target="_blank" rel="noopener">Tails</a><br>
						<a href="https://a.paddle.com/v2/click/37973/124350?link=3167" target="_blank" rel="noopener">
							<img class="mt-3" src="../tails-banner.jpg">
						</a>
						<span class="text-brand text-sm">(Affiliate link)</span>
					</div>
