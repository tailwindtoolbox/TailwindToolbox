...
<body class="bg-brand-white leading-normal tracking-normal nunito">
	...
	<!--header-->
	<div class="h-64 md:h-half mt-12 md:mt-0 md:mb-12 bg-cover bg-right flex items-center" style="background-image: linear-gradient(120deg, #84fab0 0%, #8fd3f4 100%);">	
		...
		<div class="w-full -mt-12 xl:-mt-32 px-0">
			<div class="bg-white rounded overflow-hidden shadow mx-1">
				<div class="p-3 sm:p-6 lg:p-8 text-gray-darker leading-normal text-base md:text-xl">
						...
						<div class="w-full lg:w-4/5 p-3 text-gray-darker leading-normal text-base md:text-xl">
							<p class="text-base md:text-2xl font-bold"><?= str_replace('*',$bulletCode,$pageINTRO);?></p>

	
							<div class="py-6">
								<a href="<?= $pageDL;?>" target="_blank" rel="noopener"><button class="w-full sm:w-auto bg-brand hover:bg-teal-dark text-white text-xl font-extrabold -mt-2 py-3 px-5 rounded shadow"><svg class="inline fill-current h-4 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z"/></svg> Download Template</button></a>
								<span class="mr-6"></span>	
								<a href="<?=$pageGIT;?>" target="_blank" rel="noopener"><button class="w-full sm:w-auto bg-gray-lightest hover:bg-black text-gray-darkest hover:text-white text-xl font-extrabold py-3 px-5 rounded shadow">View on GitHub</button></a>
							</div>
							...
							<div class="flex flex-wrap">
									...
									<ul class="list-reset flex flex-wrap items-center">
										...
										<li class="mr-4 pr-1 md:mr-6">
											<a href="mailto:?subject=Check%20out%20this%20link%20on%20TailwindToolbox.com&amp;body=<?PHP echo $pageDESC; ?>%20(<?PHP echo urlencode($pageURL); ?>)" target="_self" aria-label="" data-toggle="tooltip" data-placement="bottom" title="Share on Email">
												<svg viewBox="0 0 20 20" class="fill-current h-4 md:h-6 text-brand hover:text-teal" xmlns="http://www.w3.org/2000/svg"><path d="M18 2a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4c0-1.1.9-2 2-2h16zm-4.37 9.1L20 16v-2l-5.12-3.9L20 6V4l-10 8L0 4v2l5.12 4.1L0 14v2l6.37-4.9L10 14l3.63-2.9z"/></svg>
											</a>
										</li>
										<li class="mr-4 pr-1 md:mr-6">
								...
								<div class="w-full md:w-1/2 flex items-center py-6 md:py-0">
									<h3 class="font-bold">Support:</h3> <a href="https://www.buymeacoffee.com/tailwindtoolbox" target="_blank"><img src="https://www.buymeacoffee.com/assets/img/custom_images/white_img.png" alt="Buy Me A Coffee" style="height: auto !important;width: auto !important;" ></a>
								</div>
						...
						<div class="w-full pt-6">
							<h2 class="font-bold text-xl md:text-3xl text-brand pb-4">Preview</h2>
					...
					<div class="pt-6 h-1 invisible md:visible md:h-auto">
						...
						<a href="<?= $pageSRC;?>" class="bg-white text-brand border border-brand no-underline hover:no-underline hover:bg-brand hover:text-white font-extrabold -mt-2 py-3 px-5 rounded" target="_blank" rel="noopener">New Tab/Window</a>
					</div>
