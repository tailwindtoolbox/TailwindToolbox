...
<head>
	...
	<title>Tailwind Starter Template - App Landing Page Template: Windy Toolbox</title>
...
<body class="leading-normal tracking-normal text-gray-900" style="font-family: 'Source Sans Pro', sans-serif;">
	...
	<div class="h-screen bg-right bg-cover pb-14" style="background-image:url('bg.svg');">
		...
		<div class="container w-full p-6 mx-auto">
			...
			<div class="flex items-center justify-between w-full">
				<a class="flex items-center text-2xl font-bold text-indigo-400 no-underline hover:no-underline lg:text-4xl"
					href="#">
					<svg class="h-8 pr-2 text-indigo-600 fill-current" xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20">
						<path
		...
		<!--Main-->
		<div class="container flex flex-col flex-wrap items-center px-6 pt-24 mx-auto md:pt-32 md:flex-row">
			...
			<div class="flex flex-col justify-center w-full overflow-y-hidden xl:w-2/5 lg:items-start">
				...
				<p class="pb-8 font-bold text-center text-blue-400 lg:pb-6 md:text-left fade-in">Download our app:</p>
