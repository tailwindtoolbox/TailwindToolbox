...
<body class="bg-white font-sans leading-normal tracking-normal">
	...
	<!--Nav-->
	<nav class="bg-black p-4 mt-0 w-full">
        <div class="container mx-auto flex items-center">
			...
			<div class="flex pl-4 text-sm">
				<ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
				  <li class="mr-2">
					<a class="inline-block py-2 px-2 text-white no-underline" href="#">ACTIVE</a>
				  </li>
				  <li class="mr-2">
					<a class="inline-block text-grey-dark no-underline hover:text-grey-lighter hover:text-underline py-2 px-2" href="#">LINK</a>
				  </li>
				  <li class="mr-2">
					<a class="inline-block text-grey-dark no-underline hover:text-grey-lighter hover:text-underline py-2 px-2" href="#">LINK</a>
				  </li>
	...
	<div class="text-center pt-16 md:pt-32">
		<p class="text-sm md:text-base text-teal font-bold">08 FEBRUARY 2019 <span class="text-black">/</span> GETTING STARTED</p>
		<h1 class="break-normal text-3xl md:text-5xl">Welcome to Ghostwind CSS</h1>
	</div>

	<!--image-->
	<div class="container w-full max-w-4xl mx-auto bg-white bg-cover mt-8 rounded" style="background-image:url('unsplash.jpg'); height: 32rem;"></div>
		...
		<div class="mx-0 sm:mx-6">
			...
			<div class="bg-white w-full p-8 md:p-24 text-xl md:text-2xl text-grey-darkest leading-normal" style="font-family:Georgia,serif;">
				...
				<p class="text-2xl md:text-3xl mb-5">
					👋 Welcome fellow <a class="text-grey-darkest hover:text-teal no-underline border-b-2 border-teal" href="https://www.tailwindcss.com">Tailwind CSS</a> and <a class="text-grey-darkest hover:text-teal no-underline border-b-2 border-teal" href="https://www.ghost.org">Ghost</a> fan.  This starter template is an attempt to replicate the default Ghost theme <a class="text-grey-darkest hover:text-teal no-underline border-b-2 border-teal" href="https://demo.ghost.io/welcome">"Casper"</a> using Tailwind CSS and vanilla Javascript.
				</p>

				<p class="py-6 bg-teal-lightest text-center text-grey-dark">Visit <a class="text-grey-darkest hover:text-teal no-underline border-b-2 border-teal" href="https://www.tailwindtoolbox.com/templates/ghostwind" target="self" rel="noopener">www.tailwindtoolbox.com</a> to download</p>
				...
				<blockquote class="border-l-4 border-teal italic my-8 pl-8 md:pl-12">Example of blockquote - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.</blockquote>

				<p class="py-6">Example code block:</p>
				<pre class="bg-black rounded text-white font-mono text-base p-4">
					<code>
					...
					<div class="w-full text-center pt-4">
						<form action="#">
							<div class="max-w-sm mx-auto p-1 pr-0 flex flex-wrap items-center">
								<input type="email" placeholder="youremail@example.com" class="flex-1 appearance-none rounded shadow p-3 text-grey-dark mr-2 focus:outline-none">
		...
		<div class="container w-full max-w-2xl mx-auto px-2 py-8">
			<div class="flex flex-wrap -mx-2">
				<div class="w-full md:w-1/3 px-2 pb-12">
					<div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative">
						<a href="#" class="no-underline hover:no-underline">
								<img src="unsplash.jpg" class="h-48 w-full rounded-t shadow">
								<div class="p-6 h-auto md:h-48">	
									<p class="text-grey-dark text-xs md:text-sm">GETTING STARTED</p>
									<div class="font-bold text-xl text-black">Lorem ipsum dolor sit amet.</div>
					...
					<div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative">
						<a href="#" class="no-underline hover:no-underline">
								...
								<div class="p-6 h-auto md:h-48">	
									...
									<div class="font-bold text-xl text-black">Lorem ipsum dolor sit amet.</div>
									<p class="text-grey-darkest font-serif text-base mb-5">
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula. 
									</p>
								</div>
								<div class="flex items-center justify-between pin-x pin-b p-6">
									<img class="w-8 h-8 rounded-full mr-4" src="http://i.pravatar.cc/300" alt="Avatar of Author">
