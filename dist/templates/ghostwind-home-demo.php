...
<head>
    ...
    <title>Tailwind Starter Template - Ghostwind CSS Blog Index : Tailwind Toolbox</title>
		<meta name="author" content="name">
		<meta name="description" content="Free open source Tailwind CSS starter Ghost blog index template (Casper theme)">
		...
		<div class="container px-4 md:px-0 max-w-2xl mx-auto -mt-32">
			...
			<div class="mx-0 sm:mx-6">
				...
				<nav class="mt-0 w-full">
					<div class="container mx-auto flex items-center">
						...
						<div class="flex w-1/2 justify-end content-center">		
							<a class="inline-block text-grey no-underline hover:text-white hover:text-underline text-center h-10 p-2 md:h-auto md:p-4" href="#">
				...
				<div class="bg-grey-lighter w-full text-xl md:text-2xl text-grey-darkest leading-normal rounded-t">
					...
					<!--Lead Card-->
					<div class="flex h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative">
						<a href="#" class="flex flex-wrap no-underline hover:no-underline">
							<div class="w-full md:w-2/3 rounded-t">	
								<img src="https://source.unsplash.com/collection/494263/800x600" class="h-48 md:h-full w-full shadow">
							</div>
							<div class="w-full md:w-1/3">
								<div class="p-6 md:pt-12 md:px-12">	
					...
					<div class="flex flex-wrap pt-12 -mx-4">
						...
						<div class="w-full md:w-1/3 p-4">
							<div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative">
								<a href="#" class="no-underline hover:no-underline">
									<img src="https://source.unsplash.com/collection/225/800x600" class="h-48 w-full rounded-t shadow">
						...
						<div class="w-full md:w-1/3 p-4">
							<div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative">
								<a href="#" class="no-underline hover:no-underline">
									<img src="https://source.unsplash.com/collection/3106804/800x600" class="h-48 w-full rounded-t shadow">
									<div class="p-6 h-auto md:h-48">	
										<p class="text-grey-dark text-xs md:text-sm">GETTING STARTED</p>
										<div class="font-bold text-xl text-black">Lorem ipsum dolor sit amet.</div>
										<p class="text-grey-darkest font-serif text-base mb-5">
						...
						<div class="w-full md:w-1/3 p-4">
							<div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative">
								<a href="#" class="no-underline hover:no-underline">
									<img src="https://source.unsplash.com/collection/539527/800x600/daily" class="h-48 w-full rounded-t shadow">
									<div class="p-6 h-auto md:h-48">	
										<p class="text-grey-dark text-xs md:text-sm">GETTING STARTED</p>
										<div class="font-bold text-xl text-black">Lorem ipsum dolor sit amet.</div>
										<p class="text-grey-darkest font-serif text-base mb-5">
						...
						<div class="w-full md:w-1/2 p-4">
							<div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative">
									<a href="#" class="no-underline hover:no-underline">
										<img src="https://source.unsplash.com/collection/3657445/800x600" class="h-48 w-full rounded-t shadow">
										<div class="p-6 h-auto md:h-48">	
											<p class="text-grey-dark text-xs md:text-sm">GETTING STARTED</p>
											<div class="font-bold text-xl text-black">Lorem ipsum dolor sit amet.</div>
											<p class="text-grey-darkest font-serif text-base mb-5">
						...
						<div class="w-full md:w-1/2 p-4">
							<div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative">
									<a href="#" class="no-underline hover:no-underline">
										<img src="https://source.unsplash.com/collection/764827/800x600" class="h-48 w-full rounded-t shadow">
										<div class="p-6 h-auto md:h-48">	
											<p class="text-grey-dark text-xs md:text-sm">GETTING STARTED</p>
											<div class="font-bold text-xl text-black">Lorem ipsum dolor sit amet.</div>
											<p class="text-grey-darkest font-serif text-base mb-5">
						...
						<div class="w-full md:w-2/3 p-4">
							<div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative">
									<a href="#" class="no-underline hover:no-underline">
										<img src="https://source.unsplash.com/collection/325867/800x600" class="h-48 w-full rounded-t shadow">
										<div class="p-6 h-auto md:h-48">	
											<p class="text-grey-dark text-xs md:text-sm">GETTING STARTED</p>
											<div class="font-bold text-xl text-black">Lorem ipsum dolor sit amet.</div>
											<p class="text-grey-darkest font-serif text-base mb-5">
						...
						<div class="w-full md:w-1/3 p-4">
							<div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative">
									<a href="#" class="no-underline hover:no-underline">
										<img src="https://source.unsplash.com/collection/1118905/800x600" class="h-48 w-full rounded-t shadow">
										<div class="p-6 h-auto md:h-48">	
											<p class="text-grey-dark text-xs md:text-sm">GETTING STARTED</p>
											<div class="font-bold text-xl text-black">Lorem ipsum dolor sit amet.</div>
											<p class="text-grey-darkest font-serif text-base mb-5">
