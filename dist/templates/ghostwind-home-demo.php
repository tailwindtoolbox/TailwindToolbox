...
<div class="w-full m-0 p-0 bg-cover bg-bottom" style="background-image:url('cover.jpg'); height: 60vh; max-height:460px;">
	...
	<div class="container px-4 md:px-0 max-w-2xl mx-auto -mt-32">
		...
		<div class="mx-0 sm:mx-6">
			...
			<div class="pt-12">
				<p class="py-6 bg-teal-lightest text-center text-grey-dark">Visit <a class="text-grey-darkest hover:text-teal no-underline border-b-2 border-teal" href="https://www.tailwindtoolbox.com/templates/ghostwind-home" target="self" rel="noopener">www.tailwindtoolbox.com</a> to download</p>
			</div>
