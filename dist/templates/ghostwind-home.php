<?php
	...
	*/
	...
	$pageINTRO	= 'This starter template contains:<br>
				   <p>*Clone of the home page for the <a href="https://github.com/TryGhost/Casper">Casper</a> theme for Ghost</p>
				   <p>*Featured blog post at the top, followed by cards for the rest of the posts</p>';

	$bulletCode = '<svg class="inline flex-none mt-3 -mb-1 mr-4 h-6 fill-current text-green-dark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
