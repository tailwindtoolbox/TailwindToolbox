...
<head>
	...
	<title>Tailwind Starter Template - Profile Card : Windy Toolbox</title>
	<meta name="description"
		content="(Formerly Tailwind Toolbox) (Formerly Tailwind Toolbox) Free open source Tailwind CSS starter template - for use as a user profile website / card">
	<meta name="keywords"
		content="Tailwind Toolbox,tailwind,tailwindcss,tailwind css,css,starter template,free template,profile, user profile, card">
...
<body class="font-sans antialiased leading-normal tracking-wider text-gray-900 bg-cover "
	style="background-image:url('https://source.unsplash.com/1L71sPT5XKc');">



	<div class="flex flex-wrap items-center h-auto max-w-4xl mx-auto my-32 lg:h-screen lg:my-0">
		...
		<div id="profile"
			...
			<div class="p-4 text-center md:p-12 lg:text-left">
				...
				<div class="block w-48 h-48 mx-auto -mt-16 bg-center bg-cover rounded-full shadow-xl lg:hidden"
					style="background-image: url('https://source.unsplash.com/MP0IUfwrn0A')"></div>

				<h1 class="pt-8 text-3xl font-bold lg:pt-0">Your Name</h1>
				<div class="w-4/5 pt-3 mx-auto border-b-2 border-green-500 opacity-25 lg:mx-0"></div>
				<p class="flex items-center justify-center pt-4 text-base font-bold lg:justify-start"><svg
						class="h-4 pr-4 text-green-700 fill-current" xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20">
						<path
							d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z" />
					</svg> What you do</p>
				<p class="flex items-center justify-center pt-2 text-xs text-gray-600 lg:text-sm lg:justify-start"><svg
						class="h-4 pr-4 text-green-700 fill-current" xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20">
						<path
				...
				<div class="pt-12 pb-8">
					<button class="px-4 py-2 font-bold text-white bg-green-700 rounded-full hover:bg-green-900">
						Get In Touch
					</button>
				</div>

				<div class="flex flex-wrap items-center justify-between w-4/5 pb-16 mx-auto mt-6 lg:pb-0 lg:w-full">
					<a class="link" href="#" data-tippy-content="@facebook_handle"><svg
							class="h-6 text-gray-600 fill-current hover:text-green-700" role="img" viewBox="0 0 24 24"
					...
					<a class="link" href="#" data-tippy-content="@youtube_handle"><svg
							class="h-6 text-gray-600 fill-current hover:text-green-700" role="img"
