...
<head>
	...
	<!-- Primary Meta Tags -->
	<title>Windy Toolbox - Tailwind CSS Guides - <?= $pageTITLE; ?></title>
	<meta name="title" content="Windy Toolbox - Tailwind CSS Guides - <?= $pageTITLE; ?>">
	...
	<meta property="og:title" content="Windy Toolbox - Tailwind CSS Guides - <?= $pageTITLE; ?>">
	...
	<meta property="twitter:title" content="Windy Toolbox - Tailwind CSS Guides - <?= $pageTITLE; ?>">
				...
				<div class="p-3 sm:p-6 lg:p-8 text-gray-darker leading-normal text-base md:text-xl">
					...
					<div class="flex flex-wrap">
						...
						<div class="w-full lg:w-3/4 order-2 lg:order-1">
							...
							<p class="text-base">Something wrong with the guide? Or any suggestions to make it better?
								<a href="<?php echo $pageGIT; ?>">Suggest an Edit</a>.
							</p>
						</div>
					...
					<div class="text-center pt-8">
						...
						<a href="https://www.buymeacoffee.com/tailwindtoolbox" target="_blank"><img class="mx-auto"
