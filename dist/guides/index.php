...
<head>
	...
	<title>Windy Toolbox - Beginner Guides for Tailwind CSS</title>
	<meta name="description"
		content="(Formerly Tailwind Toolbox) (Formerly Tailwind Toolbox) Beginner guides for getting started with Tailwind CSS">
	<meta name="keywords"
		content="Tailwind Toolbox,tailwind,tailwindcss,tailwind css,css,beginner guides, getting started with tailwind css, tldr">
			...
			<div class="px-3">
				<h1 class="pt-6">
					<span class="px-3 mb-5 text-3xl font-bold text-center text-white bg-brand sm:text-4xl sm:mb-16"
						style="box-decoration-break: clone;-webkit-box-decoration-break: clone;"><span>Tailwind CSS
							Guides</span></span>
				</h1>
				<p
					class="max-w-3xl mx-auto my-6 text-base font-bold leading-normal text-left lg:text-xl lg:text-center">
					Getting started guides, how-to's and tutorials for beginners who are just getting started with
					Tailwind CSS</p>
			</div>
		</div>
	</div>
