...
<body class="bg-brand-white leading-normal tracking-normal nunito">
	...
	<div class="z-20 mt-24 pb-6 mb-6 flex items-center text-center" style="background-image: linear-gradient(120deg, #84fab0 0%, #8fd3f4 100%);">
		<div class="flex flex-col w-full justify-center items-center pt-6 md:pt-16">
			<div class="px-3">
				<h1 class="pt-6">
					<span class="bg-brand font-bold text-center text-white text-3xl sm:text-4xl px-3 mb-5 sm:mb-16" style="box-decoration-break: clone;-webkit-box-decoration-break: clone;"><span>Heroicons Viewer</span></span>
				</h1>
				<p class="max-w-3xl mx-auto leading-normal my-6 font-bold text-base lg:text-xl text-left lg:text-center">A simple viewer for <a class="text-brand" href="https://twitter.com/steveschoger" target="_blank" rel="nofollow">Steve Schoger</a>'s amazing <a class="text-brand" href="https://github.com/refactoringui/heroicons" target="_blank" rel="nofollow">Heroicons</a> icons.</p>
			</div>
		</div>
	</div>

	<div class="container mx-auto mb-8 flex flex-wrap" x-data="loadIcons()">

		<div class="mx-auto w-full md:w-2/5 px-2 sticky pin-t">
			...
			<textarea rows="6" readonly class="w-full p-4 border shadow rounded" id="codeSrc" x-ref="code"></textarea>
		...
		<div class="px-4 w-full md:w-3/5 flex flex-wrap items-stretch mb-2 md:px-3">
			...
			<template x-for="icon in icons" :key="icon.filename">
				<div class="flex p-2 hover:bg-white hover:shadow hover:rounded transition duration-150 ease-in-out transform hover:scale-125 ">
					<div class="mx-auto" x-html="'<svg class=&quot' + previewClasses + '&quot ' + icon.svg" x-on:click="currentSVG = icon.svg;
