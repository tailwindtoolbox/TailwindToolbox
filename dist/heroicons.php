...
<head>
	...
	<title>Windy Toolbox - Heroicons Viewer</title>
	<meta name="description" content="(Formerly Tailwind Toolbox) (Formerly Tailwind Toolbox) Steve Schoger's Heriocons viewer - set the size and colour for your icon and copy the code">
