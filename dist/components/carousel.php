<?php
	...
	*/
	...
	$pageOFFSET = '0';
	$pageINTRO	= 'Simple CSS only full width Carousel<br>
				   <p>* CSS Only Carousel, requires clicks to toggle between slides</p>
				   <p>* Code inspiration: <a href="https://codepen.io/koheishingai/pen/uKvJF">https://codepen.io/koheishingai/pen/uKvJF</a></p>';
