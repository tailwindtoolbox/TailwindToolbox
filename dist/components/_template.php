...
<head>
	...
	<meta name="description"
		content="(Formerly Tailwind Toolbox) Free open source Tailwind CSS starter components to get you started quickly to creating websites in Tailwind CSS!">
	...
	<meta property="og:description"
		content="Free open source Tailwind CSS starter components to get you started quickly to creating websites in Tailwind CSS!">
				...
				<div class="p-3 sm:p-6 lg:p-8 text-gray-darker leading-normal text-base md:text-xl">
					...
					<div class="flex flex-wrap">
						...
						<div class="w-full lg:w-3/5 xl:w-3/4 text-gray-darker leading-normal text-base ">
							...
							<div class="flex flex-wrap">
								<div class="w-full">
									<h1><span class="bg-brand font-bold text-white text-3xl md:text-5xl px-3"
										...
										<li class="mr-2 pr-1">
											<a href="https://facebook.com/sharer/sharer.php?u=<?PHP echo urlencode($pageURL); ?>"
												...
												<svg viewBox="0 0 24 24"
													class="fill-current h-4 text-brand hover:text-teal"
					...
					<div class="rounded-b overflow-hidden mx-auto w-full mt-3 sm:mt-6 lg:mt-8 mb-4 shadow-lg"
						id="device">
						<div class="window-nav flex justify-between">
							...
							<div class="flex items-center">
								...
								<button
									class="hidden md:block flex items-center hover:bg-teal-500 text-sm font-extrabold p-1 mr-2 rounded"
									onclick="goMobile()"> <svg class="h-6 w-6 fill-current text-teal-100 inline"
								...
								<button
									class="hidden md:block flex items-center hover:bg-teal-500 text-sm font-extrabold p-1 mr-2 rounded"
									onclick="goTablet()"><svg class="h-6 w-6 fill-current text-teal-100 inline"
										xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
										<path
								...
								<button
									class="hidden md:block flex items-center hover:bg-teal-500 text-sm font-extrabold p-1 mr-2 rounded"
									onclick="goDesktop()"><svg class="h-6 w-6 fill-current text-teal-100 inline"
										xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
										<path
								...
								<a href="<?= $pageSRC; ?>"
									class="flex items-center hover:bg-teal-500 text-sm font-extrabold p-1 mr-2 rounded"
									target="_blank" rel="noopener"><svg
										class="h-6 w-6 fill-current text-teal-100 inline"
										xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
										<path
						...
						<iframe id="iframecontent" src="<?= $pageSRC; ?>" style="width:100%;"
							onLoad="calcIframeHeight(<?= $pageOFFSET; ?>);window.scroll(0,0);"></iframe>
...
<div class="w-full py-4 mx-auto">
	...
	<pre><code class="html" style="padding:1rem;">';
					...
					<p class="my-16 p-6 w-full container mx-auto bg-teal-lightest text-center text-gray-dark">Find more
						components at: <a class="font-extrabold text-teal-dark hover:text-teal-darkest"
							href="https://www.tailwindtoolbox.com/starter-components" target="_blank"
							rel="noopener">www.tailwindtoolbox.com/starter-components</a></p>
