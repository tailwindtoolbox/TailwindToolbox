		...
		<div class="w-full -mt-12 xl:-mt-32 px-0">
			<div class="bg-white rounded overflow-hidden shadow mx-1">
				<div class="p-3 sm:p-6 lg:p-8 text-gray-darker leading-normal text-base md:text-xl">
					...
					<div class="pt-8 h-1 invisible md:visible md:h-auto">
					...
					echo '
					<div class="pt-12">
						<h2 class="font-bold text-xl md:text-3xl text-brand pb-4">Code</h2>
						<hr class="border border-gray-lighter">
						<p>The code for the starter component which you can drop into your existing project.</p>
						<div class="py-8">
							<button id="copyButton" onclick="copyClipboard()" class="w-full sm:w-auto bg-brand hover:bg-teal-500 text-white text-xl font-extrabold py-3 px-5 rounded shadow hover:shadow-lg">Copy to Clipboard</button>
					...
					<div class="w-full lg:w-4/5 py-4 mx-auto">
						<div id="code" class="p-3 overflow-x-auto bg-gray-lightest text-sm w-full border rounded shadow px-5 mb-5">
						<pre>';
