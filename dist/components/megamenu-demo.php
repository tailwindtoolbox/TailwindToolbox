...
<head>
  ...
  <title>Tailwind CSS Starter Component - Mega Menu : Windy Toolbox</title>
  <meta name="description" content="(Formerly Tailwind Toolbox) CSS Mega Menu - triggered by either click or hover">
  <meta name="keywords"
    content="tailwind,tailwindcss,tailwind css,css,starter component,free component,mega menu, big nav, hover nav, click nav">
            ...
            <div class="container mx-auto w-full flex flex-wrap justify-between mx-2">
              ...
              <ul
                ...
                <div class="flex items-center py-3">
                  ...
                  <a href="#" class="text-white bold border-b-2 border-blue-300 hover:text-blue-300">Find out
                    more...</a>
                </div>
              </ul>
              <ul
              ...
              <ul
                ...
                <p class="text-gray-100 text-sm">This proposal is a win-win situation which will cause a stellar
