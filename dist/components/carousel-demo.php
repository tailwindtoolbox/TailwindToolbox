...
<head>
	...
	<title>Tailwind CSS Starter Component - Carousel : Windy Toolbox</title>
	<meta name="description" content="(Formerly Tailwind Toolbox) Simple CSS Carousel in Tailwind CSS">
	<meta name="keywords" content="tailwind,tailwindcss,tailwind css,css,starter component,free component,carousel">
	...
	<div class="carousel relative shadow-2xl bg-white">
		<div class="carousel-inner relative overflow-hidden w-full">
			...
			<div class="carousel-item absolute opacity-0" style="height:50vh;">
				<div class="block h-full w-full bg-indigo-400 text-white text-5xl text-center">Slide 1</div>
			</div>
