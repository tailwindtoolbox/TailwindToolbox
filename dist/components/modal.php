...
$pageOFFSET = '500';
$pageINTRO = 'Simple Modal - Using &lt;Dialog&gt; and with transitions.</p>
				   <p>Will only show animations if user prefers and overflow hidden on the body when the modal is open.';

$bulletCode = '<svg class="flex-none inline h-6 mb-1 mr-4 fill-current text-brand" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
