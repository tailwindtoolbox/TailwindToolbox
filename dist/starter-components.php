...
<head>
	...
	<title>Windy Toolbox - Free Starter Components</title>
...
<body class="leading-normal tracking-normal bg-brand-white nunito">
		...
		<div class="flex flex-col items-center justify-center w-full pt-6 md:pt-16">
			<div class="px-3">
				...
				<p
					...
					These components are all open source and built using the standard Tailwind CSS configuration. Feel
  ...
  <a href="##statlink##" class="native-card" style="background: ##backgroundColor##; color: ##textColor##;">
	...
	<p class="container w-full p-6 mx-auto my-8 text-center bg-teal-lightest text-gray-dark">Find more components at: <a
			class="font-extrabold text-teal-dark hover:text-teal-darkest" href="https://www.alpinetoolbox.com/examples"
			target="_blank" rel="noopener">www.AlpineToolbox.com/examples</a></p>
