...
<head>
    ...
    <title>Tailwind Toolbox - Free Starter Templates</title>
		<meta name="description" content="Free open source Tailwind CSS components to copy and paste into your next project">
...
<body class="bg-brand-white leading-normal tracking-normal nunito">
	...
	<div class="h-64 md:h-half mt-6 bg-cover bg-right flex items-center" style="background-image: linear-gradient(120deg, #84fab0 0%, #8fd3f4 100%);">	
		<div class="flex-1 text-center">
			<span class="bg-brand font-bold text-center text-white text-3xl md:text-5xl px-3 mb-5 sm:mb-16" style="box-decoration-break: clone;-webkit-box-decoration-break: clone;">Tailwind Components</span>
		</div>
	</div>
	...
	<div class="container mx-auto mb-8" id="post-content">
		<div class="w-full -mt-12 md:-mt-32 px-0">
			...
			<div class="bg-white rounded overflow-hidden shadow mx-1">
				<div class="flex flex-wrap flex-row-reverse md:flex-row p-3 sm:p-6 lg:p-8 text-grey-darker leading-normal text-base md:text-xl">
					...
					<!--maincol-->
					<div class="w-full md:w-4/5 pl-0 md:pl-6">
						...
						<div id="code" class="overflow-x-auto bg-grey-lightest text-sm md:text-base w-full border rounded shadow px-5 mb-5">
							<pre>
<?php
$code_snippet = file_get_contents('components/responsive-header-CODE.php');
...
function w3CodeColor(elmnt,mode){var lang=(mode||"html");var elmntObj=(document.getElementById(elmnt)||elmnt);var elmntTxt=elmntObj.innerHTML;var tagcolor="blue";var tagnamecolor="maroon";var attributecolor="gray";var attributevaluecolor="teal";var commentcolor="green";var cssselectorcolor="brown";var csspropertycolor="red";var csspropertyvaluecolor="mediumblue";var cssdelimitercolor="black";var cssimportantcolor="red";var jscolor="black";var jskeywordcolor="mediumblue";var jsstringcolor="brown";var jsnumbercolor="red";var jspropertycolor="black";elmntObj.style.fontFamily="Consolas,'Courier New', monospace";if(!lang){lang="html"}
