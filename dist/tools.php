...
<head>
	...
	<title>Windy Toolbox - Useful Tools and Utilities for Tailwind CSS</title>
	<meta name="description"
		content="(Formerly Tailwind Toolbox) Useful Tools and Utilities for Tailwind CSS to help you setup for your next project">
	<meta name="keywords"
			...
			<div class="px-3">
				<h1 class="pt-6">
					<span class="px-3 mb-5 text-3xl font-bold text-center text-white bg-brand sm:text-4xl sm:mb-16"
						style="box-decoration-break: clone;-webkit-box-decoration-break: clone;"><span>Tailwind Tools
				...
				<p
					...
					Some useful tools and utilities to help you setup your development environment and become more
					familiar with Tailwind CSS</p>
			</div>
		</div>
	</div>
