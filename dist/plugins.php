		...
		<div class="flex flex-col items-center justify-center w-full pt-6 md:pt-16">
			<div class="px-3">
				...
				<p
					...
					Some useful plugins for extending Tailwind CSS. Find out more about writing your own plugin <a
						class="font-extrabold text-teal-dark hover:text-teal-darkest"
						href="https://tailwindcss.com/docs/plugins" target="_blank" rel="noopener">here</a></p>
			</div>
		</div>
	</div>
		...
		<div class="w-full pb-6 md:w-1/5">
			<div class="sticky flex flex-col pin-t" style="top:9em;">
				...
				<div class="order-2 w-full pt-6 pl-0 pl-3 bg-brand-white md: md:pt-0 md:order-1">
					...
					<ul
						class="container flex flex-row mx-auto text-sm border-b scroll list-reset md:flex-col md:pb-4 md:text-base">
						<li class="mr-1">
							<button class="-mb-px tab active-tab" onclick="javascript:filterTemplates('');"
								data-twfilter="all">All</button>
						</li>
						<?php
  ...
  <a href="##statlink##" class="native-card" style="background: ##backgroundColor##; color: ##textColor##;">
	...
	`
		...
		<div class="w-full px-0 md:w-4/5">
			...
			<p class="container w-full p-6 mx-auto my-8 text-center text-gray-dark">If you have any useful plugins which
				will make your Tailwind CSS experience better, please drop us a tweet: <a
					class="font-extrabold text-teal-dark hover:text-teal-darkest"
					href="https://www.twitter.com/tailwindtoolbox" target="_blank" rel="noopener">@TailwindToolbox</a>
			</p>
