			...
			<form id="requestForm">
				...
				<div class="mt-4">
					...
					<div class="mt-2">
						...
						<label class="inline-flex items-center ml-6">
							<input type="radio" class="form-radio text-brand" name="section" value="Generator">
				...
				<button onclick="postStuff()" type="button" name="submit_btn" class="mt-6 w-full max-w-xs flex items-center justify-center bg-brand hover:bg-teal-500 outline-none focus:border-teal-900 text-white font-extrabold py-3 px-5 rounded shadow"><svg class="inline fill-current h-4 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
			...
			<div>
				<div class="card">
					...
					<p class="card-author text-brand"><svg class="inline h-2 pr-2 fill-current text-teal" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						</svg><span id="outputAuthor">Author / @github</a></p>
