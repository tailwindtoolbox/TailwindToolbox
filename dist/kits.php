...
<head>
	...
	<meta name="description" content="Tailwind CSS UI kits and website building tools to quickly start your next project">
	<meta name="keywords" content="tailwind,tailwindcss,tailwind css,css,starter template,free components, ui kits, ui components, website builder, builder">
...
<body class="bg-brand-white leading-normal tracking-normal nunito">
	...
	<div class="z-20 mt-24 pb-6 mb-6 flex items-center text-center" style="background-image: linear-gradient(120deg, #84fab0 0%, #8fd3f4 100%);">
		<div class="flex flex-col w-full justify-center items-center pt-6 md:pt-16">
			<div class="px-3">
				<h1 class="pt-6">
					<span class="bg-brand font-bold text-center text-white text-3xl sm:text-4xl px-3 mb-5 sm:mb-16" style="box-decoration-break: clone;-webkit-box-decoration-break: clone;"><span>Tailwind UI Kits and Building tools</span></span>
				</h1>
				<p class="max-w-3xl mx-auto leading-normal my-6 font-bold text-base lg:text-xl text-left lg:text-center">Tailwind CSS UI Kits, Component Kits and website building tools to speed up your development process.</p>
			</div>
		</div>
	</div>
			...
			<div class="sticky pin-t flex flex-col" style="top:9em;">
				...
				<div class="w-full bg-brand-white pl-3 pt-6 md: pl-0 md:pt-0 order-2 md:order-1">
					...
					<ul class="container scroll mx-auto list-reset flex flex-row md:flex-col border-b md:pb-4 text-sm md:text-base bounce-in-right">
						...
						<?php
						$filters = array('UI Kit', 'Page Builder', 'Component Kit', 'Generator');
