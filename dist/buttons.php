...
<head>
    ...
    <title>Windy Toolbox - Components - Buttons Generator</title>
...
<body class="leading-normal tracking-normal bg-brand-white nunito">
    ...
    <div class="z-20 flex items-center pb-6 mt-24 mb-6 text-center bg-cover" style="background-image: url(bg.svg)">
        <div class="flex-1 text-center">
            <span class="px-3 mb-5 text-3xl font-bold text-center text-white bg-brand md:text-5xl sm:mb-16"
                style="box-decoration-break: clone;-webkit-box-decoration-break: clone;">Tailwind Button
                Playground</span>
        </div>
    </div>
            ...
            <div class="mx-1 overflow-hidden bg-white rounded shadow">
                <div class="flex flex-wrap p-3 text-base leading-normal sm:p-6 text-grey-darker md:text-xl">
                    <p class="my-2 font-bold">
                        ...
                        <br>Based on: <a
                            href="https://github.com/minthemiddle/tailwind-button-playground">https://github.com/minthemiddle/tailwind-button-playground</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container flex flex-wrap inline-block mx-auto mb-8">
        ...
        <div class="w-full px-0 md:w-4/5">
            ...
            <div class="mx-1 overflow-hidden text-center bg-white rounded shadow md:sticky md:pin-t md:z-50"
                style="top:9em;">

                <div class="flex items-center justify-center py-6">
                    <!-- Start: Component -->
                    <button id="button1"
                        class="p-2 text-sm text-white no-underline bg-black hover:underline">Submit</button>
                    <!-- end: Component -->
                </div>


                <div class="w-4/5 p-1 mx-auto bg-gray-100 border rounded shadow"
                    onmouseover="this.classList.toggle('cursor-copy')" onclick="copyToClipboard(ac.innerHTML)">
                ...
                <div class="flex flex-wrap items-center justify-center my-8">
                    ...
                    <input id="buttontext"
                        class="block w-32 p-4 mr-4 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded-lg appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                        value="Submit" onchange="setButtonText();">

                    <button class="p-4 mr-4 bg-gray-200 rounded-lg" onclick="copyToClipboard(ac.innerHTML)">Copy
                        classes</button>
                    <button class="p-4 mr-4 bg-gray-200 rounded-lg"
                        onclick="copyToClipboard(`<div class='${ac.innerHTML}'>Submit</div>`)">Copy full tag</button>

                    <div class="flex items-center">
                        <button class="p-4 bg-gray-200 rounded-lg" id="r" onclick="getContrast()">Check Contrast
                            Ratio</button>
            ...
            <div class="flex flex-wrap justify-center mt-8">
                ...
                <div id="control-textsize" class="mt-4 mb-6">
                    ...
                    <div class="relative">
                        <select id="textsize"
                            ...
                            onchange="resetComponentClasses('text-xs','text-sm','text-base','text-lg','text-xl','text-2xl','text-3xl','text-4xl','text-5xl','text-6xl');addComponentClass(value);">
                ...
                <div id="control-decoration" class="mt-4 mb-6 ml-4">
                    ...
                    <div class="relative">
                        <select id="decoration"
                            class="block w-full px-4 py-3 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            onchange="resetComponentClasses('underline','line-through','no-underline');addComponentClass(value);">
                ...
                <div id="control-padding" class="mt-4 mb-6 ml-4">
                    ...
                    <div class="relative">
                        <select id="padding"
                            class="block w-full px-4 py-3 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            onchange="clearFields('p-');addComponentClass(value);">
                ...
                <div id="control-background-color" class="mt-4 mb-6 ml-4">
                    ...
                    <div class="relative">
                        <select id="background"
                            class="block w-full px-4 py-3 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            onchange="clearFields('bg-');addComponentClass(value,bgcolorvalue.innerHTML);">
                    ...
                    <div class="flex">
                        <input type="range" min="100" max="900" value="500" step="100" class="mr-2 slider" id="bgcolor"
                            onchange="clearFields('bg-');addComponentClass(document.getElementById('background').value,bgcolorvalue.innerHTML);">
                        <div id="bgcolorvalue"></div>
                    </div>
                </div>
                <div id="control-text-color" class="mt-4 mb-6 ml-4">
                    ...
                    <div class="relative">
                        <select id="text"
                            class="block w-full px-4 py-3 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            onchange="resetComponentClasses('text-black', 'text-white', 'text-gray', 'text-red', 'text-orange','text-yellow','text-green','text-teal','text-blue','text-indigo','text-purple','text-pink');addComponentClass(value,textcolorvalue.innerHTML)">
                    ...
                    <div class="flex">
                        <input type="range" min="100" max="900" value="500" step="100" class="mr-2 slider"
                            id="textcolor"
                            onchange="resetComponentClasses('text-black', 'text-white', 'text-gray', 'text-red', 'text-orange','text-yellow','text-green','text-teal','text-blue','text-indigo','text-purple','text-pink');addComponentClass(document.getElementById('text').value,textcolorvalue.innerHTML);">
                        <div id="textcolorvalue"></div>
                    </div>
                </div>
                <div id="control-shadow" class="mt-4 mb-6 ml-4">
                    ...
                    <div class="relative">
                        <select id="padding"
                            class="block w-full px-4 py-3 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            onchange="resetComponentClasses('shadow-none', 'shadow','shadow-md','shadow-lg','shadow-xl','shadow-2xl','shadow-inner','shadow-outline');addComponentClass(value);">
                ...
                <div id="control-border-rounding" class="mt-4 mb-6 ml-4">
                    ...
                    <div class="relative">
                        <select id="padding"
                            class="block w-full px-4 py-3 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            onchange="resetComponentClasses('rounded-sm', 'rounded', 'rounded-lg', 'rounded-full');addComponentClass(value);">
                ...
                <div id="hover-control-decoration" class="mt-4 mb-6 ml-4">
                    ...
                    <div class="relative">
                        <select id="hover-decoration"
                            class="block w-full px-4 py-3 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            onchange="resetComponentClasses('hover:underline','hover:line-through','hover:no-underline');addComponentClass(value);">
                ...
                <div id="hover-control-background-color" class="mt-4 mb-6 ml-4">
                    ...
                    <div class="relative">
                        <select id="hover-background"
                            class="block w-full px-4 py-3 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            onchange="clearFields('hover:bg-');addComponentClass(value,hoverbgcolorvalue.innerHTML);">
                    ...
                    <div class="flex">
                        <input type="range" min="100" max="900" value="500" step="100" class="mr-2 slider"
                            id="hoverbgcolor"
                            onchange="clearFields('hover:bg-');addComponentClass(document.getElementById('hover-background').value,hoverbgcolorvalue.innerHTML);">
                        <div id="hoverbgcolorvalue"></div>
                    </div>
                ...
                <div id="hover-control-text-color" class="mt-4 mb-6 ml-4">
                    ...
                    <div class="relative">
                        <select id="hover-text"
                            class="block w-full px-4 py-3 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            onchange="resetComponentClasses('hover:text-black', 'hover:text-white', 'hover:text-gray', 'hover:text-red', 'hover:text-orange','hover:text-yellow','hover:text-green','hover:text-teal','hover:text-blue','hover:text-indigo','hover:text-purple','hover:text-pink');addComponentClass(value,hovertextcolorvalue.innerHTML)">
                ...
                <div id="hover-control-shadow" class="mt-4 mb-6 ml-4">
                    ...
                    <div class="relative">
                        <select id="hover-padding"
                            class="block w-full px-4 py-3 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            onchange="resetComponentClasses('hover:shadow-none', 'hover:shadow','hover:shadow-md','hover:shadow-lg','hover:shadow-xl','hover:shadow-2xl','hover:shadow-inner','hover:shadow-outline');addComponentClass(value);">
            ...
            <div class="mt-4">
                ...
                <div class="mt-4"><em>About:</em> MIT license, <a
                        href="https://github.com/minthemiddle/tailwind-button-playground" target="_blank">project on
                        Github</a>, PR's very welcome!</div>
            </div>
