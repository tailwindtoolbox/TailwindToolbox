			...
			<ul class="container mx-auto list-reset flex border-b text-base bounce-in-right">
				...
				<li class="flex flex-1 justify-end">
					<a href="https://www.tailwindtoolbox.com/submit" class="<?php echo (strpos($_SERVER[REQUEST_URI], 'submit') !== false ? 'active-tab' : 'tab');?>">
						<svg class="inline fill-current text-teal-lightest h-4 pr-2 md:pr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M3 6c0-1.1.9-2 2-2h8l4-4h2v16h-2l-4-4H5a2 2 0 0 1-2-2H1V6h2zm8 9v5H8l-1.67-5H5v-2h8v2h-2z"/></svg>
