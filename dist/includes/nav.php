	...
	<div class="w-full container mx-auto flex justify-between flex-wrap items-center mt-0 px-3 py-3">
		...
		<div id="search-container" class="hidden pt-3 md:pt-0 md:block w-full md:w-1/2 max-w-md mx-auto md:ml-auto order-3">			
			<div class="relative max-w-3xl mx-auto px-6">
				...
				<input id="search-toggle" type="search" placeholder="Enter search term ('/' to focus)" class="block w-full bg-brand-white focus:outline-none focus:bg-white focus:shadow text-gray-700 font-bold rounded-lg pl-12 py-3" onkeyup="updateSearchResults(this.value);">
				</div>
			</div>
		</div>
		<!--End Search-->
