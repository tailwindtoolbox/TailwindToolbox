<!--section-->
<div class="container mx-auto mt-6 mb-16" id="marketplace">
	<div class="w-full px-1 md:px-0">
					...
					<a href="{{url}}" class="no-underline hover:no-underline">
						<div class="card">
							<div class="relative">
								...
								{{new}}
								{{sticky}}
								<div class="absolute bottom-0 right-0 flex justify-end mb-2 text-center">
								<span class="px-5 py-2 my-2 font-extrabold text-white no-underline rounded-l shadow hover:no-underline hover:text-white bg-brand hover:bg-teal-500">
								{{download}}</span>
							</div>
		...
		<p class="p-4 m-2 mt-4 font-bold border-2 sm:mt-0 border-brand">
			If you want to showcase your product here, get in touch with me on twitter <a class="footerlink"
				href="https://twitter.com/amritnagi">@amritnagi</a><br>
			Your product will need to be available on a platform where affiliates can be setup (e.g. LemonSqueezy or
			Gumroad)
		</p>
